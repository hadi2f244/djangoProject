...
urlpatterns = patterns('',
    ...
    url(r'^articles/get/(?P<article_id>\d+)/$','blog.backEnd.views.article'),
    url(r'^articles/del/(?P<article_id>\d+)/$','blog.backEnd.views.articleDel'),
    url(r'^articles/edit/(?P<article_id>\d+)/$','blog.backEnd.views.articleEdit'),
    ...
    url(r'^comments/articles/get/(?P<article_id>\d+)/$','blog.backEnd.views.cArticle'),
