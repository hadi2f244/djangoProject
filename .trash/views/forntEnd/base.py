...
def register_user(request,context):
	...
	if request.method =="POST":	
		...
		if form.is_valid():
			form.save()
			return render_to_response('register_success.html',context) #no need to create a new url like register_success just render that html is enough (url is /accounts/register)
